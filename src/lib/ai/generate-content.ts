...
- image_prompt: Detailed ENGLISH description (60-100 words). MUST be PHOTOREALISTIC like a professional food/lifestyle magazine photo. For restaurants/pizzerias: focus on the FOOD (close-up pizza, ingredients, table setting, steaming dishes) or the ATMOSPHERE (cozy interior, warm lighting, empty or blurred background tables) — NOT on people's faces. STRICTLY NO human faces, NO portraits, NO group shots with visible faces. If humans appear at all, show only hands reaching for food, blurred silhouettes, or backs. NO text overlays, NO cartoons, NO illustrations. Specify lighting (e.g. "warm golden hour light", "dramatic overhead food photography lighting"), composition (e.g. "flat lay", "45-degree angle", "close-up macro"), mood.
${lang === 'fi' ? `
